...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝐕2 TWITTER DOWNLOADER* 〕━━━⊷\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝐕2 APK Downloader* 〕━━━┈⊷
┃ 📦 *Name:* ${app.name}
┃ 🏋 *Size:* ${appSize} MB
┃ 📦 *Package:* ${app.package}
...
async (conn, mek, m, { from, args, q, reply }) => {
    try {
        ...
        const caption = `🎵 *𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝐕2 TikTok Video* 🎵\n\n` +
...
async (conn, mek, m, { from, args, q, reply, react }) => {
    try {
        ...
        let caption = `📢 *𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝐕2 YouTube Community Post* 📢\n\n` +
